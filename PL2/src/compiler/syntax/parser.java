...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Apr 24 15:31:29 CEST 2018
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    ...
    "\000\010\004\230\010\233\022\227\001\002\000\004\025" +
    "\uffe0\001\002\000\004\025\041\001\002\000\006\010\uffdf" +
    ...
    "\004\021\035\001\002\000\004\004\253\001\002\000\026" +
  ...
  protected static final short[][] _reduce_table = 
    ...
    "\024\231\001\001\000\004\061\036\001\001\000\004\035" +
    ...
    "\001\001\000\006\015\077\023\035\001\001\000\030\003" +
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
	...
	semanticErrorManager.semanticFatalError("Error. No se pueden pasar tipos estructurados como parametros en la linea  " + id.getLine());
		...
		Object listaTipos = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 34: // declar_funcion ::= ENTERO IDENTIFICADOR declar_parametros NT$7 bloque_sentencias 
            {
              Object RESULT =null;
		...
		Object bloque = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
					...
					ScopeIF sc = scopeManager.getCurrentScope();
					SymbolTableIF ts = sc.getSymbolTable();
					System.out.println("Estoy en el scope interno..." + sc);
					if (scopeManager.containsSymbol(id.getLexema())) {

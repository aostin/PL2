...
public class TypeSimple
    extends TypeBase
{
	private static int maxtam=32727;
	private static int mintam=-32728;
	private int size;
    ...
    public static boolean rangoCorrecto(int entero) {
    	if (entero>=mintam && entero<=maxtam)
    		return true;
    	else
    		return false;
    }
    
    public static boolean rangoPositivo (int entero) {
    	if (entero>=0 && entero<=maxtam)
    		return true;
    	else
    		return false;
    }
